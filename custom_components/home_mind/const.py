...
##### Added by Home Mind #####
from custom_components.home_mind.home_mind.const import CONF_LAST_RECOGNIZED_FACE_ENTITY
...
##### Added by Home Mind #####
DEFAULT_CONVERSATION_NAME = "HomeMind Conversation"  # Can not have space in HomeMind here
DEFAULT_AI_TASK_NAME = "Home Mind AI Task"
DEFAULT_NAME = "Home Mind Conversation"
