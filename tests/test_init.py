...
from custom_components.home_mind import (
    async_setup_entry,
    async_unload_entry,
    async_update_options,
)
from custom_components.home_mind.const import DOMAIN
from custom_components.home_mind.home_mind.coordinator import (
    HomemindCoordinator,
)
...
#     assert isinstance(hass.data[DOMAIN][config_entry.entry_id], HomemindCoordinator)
